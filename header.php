...
<head>
  ...
  <link rel="manifest" href="<?php echo get_stylesheet_directory_uri(); ?>/assetsfavicons/site.webmanifest">
      ...
      <div class="fixed-top bg-light">
        ...
        <nav id="nav-main" class="navbar navbar-expand-lg navbar-light">
          ...
          <div class="container">
            ...
            <!-- Navbar Brand -->
            <a class="navbar-brand xs d-md-none" href="<?php echo esc_url(home_url()); ?>"><img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/assets/logo/logo-sm.svg" alt="logo" class="logo xs"></a>
            <a class="navbar-brand md d-none d-md-block" href="<?php echo esc_url(home_url()); ?>"><img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/assets/logo/logo.svg" alt="logo" class="logo md"></a>
